...
<div class="container">
    <form:form id="productForm" method="post" action="/supersale/manage/product/create" modelAttribute="product">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <button type="button" class="btn btn-default"
                                onclick="javascript:location.href='/supersale/manage/product'">取消
                        </button>
